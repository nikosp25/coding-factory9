...
public class ExpressionsApp {
    public static void main(String[] args) {
        ...
        sub = num1 - num2;
        mul = num1 *num2;
        div = num1 / num2; // h diairesh akeraiwn dinei panta akeraio
        mod = num1 % num2; // to upoloipo ths diaireshs

        System.out.printf("Sum : %d,Sub : %d,  Mul: %d, Div: %d, Mod: %d%n", sum, sub, mul, div, mod);
        result1 = result1 + 1; //allazei h timh tou result1 ->1
        ...
        result4 = num1++; //result4 -> 12 kai meta to num1 ->13
        result5 = ++num2; // edw prwta tha ginei 6 kai meta tha kataxwrithei
